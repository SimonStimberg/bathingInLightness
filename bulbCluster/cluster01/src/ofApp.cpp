...
void ofApp::update(){
    ...
    // OBJECT RECOGNITION
    // learn the background to detect humans moving in front of it
...
void ofApp::draw(){
    ...
    ofSetColor(255);
    ofDrawBitmapStringHighlight("PRESS\n\n\'B\' to show light bulbs\n\'P\' to show particles\n\'C\' to show camera image\n\n\'1\' to change to POSITIVE mood\n\'2\' to change to NEUTRAL mood\n\'3\' to change to NEGATIVE mood\n\nSPACEBAR to learn background\n\nFramerate: " + ofToString(ofGetFrameRate()), 50, ofGetHeight() * 0.5 - 100);
...
//    ofDrawSphere(singleAttractor, 10.0);
    ...
    ofPopMatrix();
    ofTranslate(ofGetWidth() - 300, ofGetHeight() * 0.5 - 100);
    
    
    // OBJECT RECOGNITION REPORT
    
    // report whether there has been found an object (hence "attractor")
...
//    if(!drawCam) {
//        ofSetColor(50);
//        ofDrawRectangle(0, 0, 150, 120);
//        if(attractorFound) {
//            ofSetColor(255, 100, 0);
//            ofDrawCircle(detectionPoint.x * 150, detectionPoint.y * 120, 10);
//        }
//    }
//    else {
//
