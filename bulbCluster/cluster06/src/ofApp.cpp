...
void ofApp::setup(){
    ...
    boxSize = 500; // size of the bounding box the particles live in
    int num = 100; // amount of Particles
    refreshRate = 50; // interval sending to Arduino in Milliseconds (40ms = "25fps")
    int numberOfBulbs = 200;     // has only effect on the creation of the random cluster
...
//    }
    ...
    // currentParticlePosition = kinectPointCloud;  // to bypass the particles and send the kinect information directly to the bulbs
