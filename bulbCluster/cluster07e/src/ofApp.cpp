...
void ofApp::setup(){
    ...
    bulbCluster.setup(boxSize);  // use this to initialize a physical cluster with hard-coded positions
    // bulbCluster.setup(boxSize, numberOfBulbs);  // use this to create a random cluster
