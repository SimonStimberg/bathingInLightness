...
//        grayRescaled = grayImg;
//        grayRescaled.resize(320, 240);

//        ofxCv::resize(colorImg, rescaledMat, 0.5, 0.5);
...
//    kinect.draw(0, 20, kinect.getWidth(), kinect.getHeight());
    grayImg.draw(400, 0);
